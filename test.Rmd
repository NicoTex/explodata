...
### Data specimen (tous les spécimens des espèces endémiques du Gabon)
...
### Data species (metadata sur les espèces endémiques du Gabon)
...
# Gabonese plant endemism analysis
...
```{r nb-specimens, echo=FALSE, message = FALSE, warning=F, fig.height = 10, fig.width = 10, fig.cap='Number of species with given number of specimen'}
...
Plot 2 : Proportion des habitus chez esp?ces end?miques
...
Plot 3: Proportion des familles chez esp?ces end?miques
Plot 4: Famille ayant le plus de % d'esp?ces end?mique (avec nombre d'esp?ce end?mique indiqu?)
Plot 5: Genres les plus repr?sent?s chez esp?ces end?miques
...
Plot 6: Proportion des cat?gories UICN chez esp?ces end?miques
Plot 7: Proportion des habitus dans cat?gories UICN des esp?ces end?miques
